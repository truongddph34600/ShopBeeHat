        ...
        <div class="col-lg-10">
            <div class="form-container">
                <div class="card-header d-flex justify-content-between align-items-center mb-4">
                    <span><i class="fas fa-user-edit me-2"></i>Chỉnh Sửa Thông Tin Nhân Viên</span>
                </div>
                ...
                <div class="avatar-wrapper">
                    ...
                    <div class="employee-id mt-2">
                        <i class="fas fa-id-badge me-1"></i>Mã NV: <?php echo $kq_sua['MaNV']; ?>
                    </div>
                </div>

                <form method="POST" action="nhanvien/xuly.php" enctype="multipart/form-data">
                    <input type="hidden" name="manv" value="<?php echo $kq_sua['MaNV']; ?>">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="tennv" name="tennv" value="<?php echo $kq_sua['TenNV']; ?>" autofocus>
