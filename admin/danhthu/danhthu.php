...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body row">
                    <select name="nam" class="browser-default custom-select " style="width: 100px; margin-top: 10px;"><?php
					    ...
					    { ?>
                        <option <?php if($value==$nam3){echo 'selected';} ?> value="<?php echo $value ?>">
                            <?php echo $value ?></option>
                        <?php } ?>
                    </select>
                    <button class="btn btn-indigo " style="height: 38px;margin-top: 10px;" type="sub"
                        name="xem">Xem</button>
                </div>
            </div>
        </form>
        ...
        <form class="col-xl-8 col-md-6 mb-4" action="?action=danhthu" method="POST" accept-charset="utf-8">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body row">
                    <input class="btn btn-light" type="date" name="tu" required><input class="btn btn-light" type="date"
                        name="den" required>
...
?>
    <div class="card">
        <div class="card-body">
            ...
            <h6 class="text-right"><a
                    href="index.php?action=danhthu&view=ctdt&thang=<?php echo $month; ?>&nam=<?php echo $nam2 ?>">Xem
                    chi tiết</a></h6>
        </div>
    </div>
    <br>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h6 class="text-right"><a
                    href="index.php?action=danhthu&view=ctdt&tu=<?php echo $tu; ?>&den=<?php echo $den ?>">Xem chi
                    tiết</a></h6>
        </div>
    </div>
